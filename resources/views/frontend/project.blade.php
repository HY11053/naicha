...
@section('description') 21奶茶加盟网{{$title}}频道实时发布更新最新{{$title}}信息及{{$title}}品牌资讯。包含行业最全{{$title}}加盟项目及品牌。{{$title}}的各类费用投资和成本预算 @stop
...
//            alert("项目对比最多可选三个!");
        ...
        bybReset.bind("click", function(){
            selectedplan.html('');
            $.cookie('prosion',null,{path:'/',domain:'www.21yinpin.com'});
            proLayer.hide();
